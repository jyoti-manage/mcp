...
# create an MCP client that connects to two servers.
...
async def run():
    try:
        ...
        # two clients for connecting to two servers, one for Airbnb server and one for Memory server
        # another efficient way can be: One client connected to many servers
