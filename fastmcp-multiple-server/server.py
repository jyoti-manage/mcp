...
async def weather_data():
    ...
    return {"temperature": 70, "conditions": "sunny", "humidity": 45, "wind_speed": 5}
...
def check_app_status() -> dict[str, str]:
    ...
    return {"status": "running", "version": "1.0.0", "uptime": "3h 10m"}
...
# Add a tool AFTER mounting - it will be accessible through app (Changes to subserver immediately reflected) 
@news_app.tool
def added_later():
