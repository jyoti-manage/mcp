...
# let server know that the client has connected
...
# this is everything that we need to do to talk to the server
# run the script with sh script_stateful.sh in bash